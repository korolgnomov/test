...
$calendar .= "<table class='table table-dark table-striped'>";
$calendar .= "<tr><th>дата экза</th><th>предмет</th><th>специальность</th></tr>";
while($rows=mysqli_fetch_assoc($result)){
  ...
  if($currentdate==$row){
    ...
    $calendar .= "<tr><td> $rowstabledate</td><td>$rowstablesub</td><td>";
     $result2=mysqli_query($link,$sql);
